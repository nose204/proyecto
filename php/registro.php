...
<body>
    ...
    <main>
        <section class="form">
            ...
            <p class="form__description"><a href="login.php">iniciar seccion</a></p>

            <form action="../validaciones/registro-usuario.php" method="post">
                ...
                <button type="submit" class="form__submit" id="submit">crear</button>
            </form>
